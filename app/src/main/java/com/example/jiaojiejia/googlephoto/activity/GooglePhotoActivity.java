 ...
 */
@RuntimePermissions
public class GooglePhotoActivity extends BaseActivity implements GooglePhotoContract.View, PhotoPreviewProxy {

    @BindView(R.id.fl_container)
    PhotoListLayout mFlContainer;
    @BindView(R.id.dtv_photo_dir)
    DrawableTextView mDtvPhotoDir;
    @BindView(R.id.dtv_finish)
    TextView mDtvFinish;
    @BindView(R.id.tv_select_size)
    TextView mTvSelectSize;
    @BindView(R.id.rv_filedir)
    RecyclerView mRvFiledir;
    @BindView(R.id.design_bottom_sheet)
    LinearLayout mDesignBottomSheet;
    ...
    @OnClick({R.id.dtv_photo_dir, R.id.ll_finish})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.dtv_photo_dir:
