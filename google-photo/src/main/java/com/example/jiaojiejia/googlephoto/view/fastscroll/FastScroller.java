...
import com.example.jiaojiejia.googlephoto.view.fastscroll.viewprovider.DefaultScrollerViewProvider;
import com.example.jiaojiejia.googlephoto.view.fastscroll.viewprovider.ScrollerViewProvider;
...
public class FastScroller extends LinearLayout {
    ...
    public void initTimelineView() {
        if(timelineProvider == null || timelineProvider.getPercents() == null
                || timelineProvider.getTitles() == null) return;
...
//                isRecyclerViewNotScrollable() ||
    ...
    private void setRecyclerViewPosition(float relativePos) {
        ...
        if(titleProvider!=null && bubbleTextView!=null) {
            ...
            bubbleTextView.setVisibility(TextUtils.isEmpty(title) ? View.INVISIBLE : View.VISIBLE);
        }
    }
