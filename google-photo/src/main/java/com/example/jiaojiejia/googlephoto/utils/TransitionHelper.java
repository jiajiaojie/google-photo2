...
public class TransitionHelper {
    ...
    /**
     * Create the transition participants required during a activity_webview transition while
     * avoiding glitches with the system UI.
     *
     * @param activity The activity_webview used as start for the transition.
